...
Mock.mock(`${baseURL}/seller`, "GET", {
  ...
  seller: {
    ...
    sellCount: 90,
    bulletin:
      "小号餐饮管理有限公司是一家餐饮连锁为主的民营企业,自2010年开创第一家彭厨本味馆以来,是以经营地道本土湖湘湘菜为特色的餐厅。如果去长沙考察,几乎当地所有同行都会推荐一家餐厅——彭厨。这家店不仅生意好,经营手法也特别接地气。加盟咨询:0731-88093999。",
    supports: [
      {
        type: 0,
    ...
    avatar:
      "http://p1.meituan.net/120.0/xianfu/42fa50a0980fda34afe0332787c24103343853.jpg",
    pics: [
